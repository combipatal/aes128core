...
if {[sizeof_collection [get_clocks -quiet clk_fast_aes]] == 0} {
    if {[sizeof_collection [get_pins -quiet u_ctrl/u_icg_aes/U4/Y]] > 0} {
        create_generated_clock [get_pins u_ctrl/u_icg_aes/U4/Y] \
            -name clk_fast_aes \
            -source [get_pins u_ctrl/u_icg_aes/U4/A1] \
            -combinational
    } elseif {[sizeof_collection [get_pins -quiet u_ctrl/u_icg_aes/gclk]] > 0} {
