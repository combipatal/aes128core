...
typedef struct TableAssignLayoutOnClkOpt_ {
    ...
    RmaSeqPrimOutputOnClkOpt  I1249;
...
struct dummyq_struct {
    ...
    struct futq * I1371;
    struct futq * I1372;
    struct sched_table * I1373;
    struct futq_info * I1375;
    struct futq_info * I1377;
    U  I1378;
    U  I1379;
    U  I1380;
    U  I1381;
    ...
    EBLK  * I1434;
    int I1435;
    struct vcs_globals_t * I1436;
    clock_struct  I1438;
    unsigned long long I1439;
    EBLK  * I1440;
    EBLK  * I1441;
    void * I1442;
...
void  rmaPropagate0_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate1_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate2_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate3_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate4_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate5_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate6_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate7_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate8_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate13_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate14_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate15_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate16_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate19_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
...
void  rmaPropagate20_f_simv_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1495, U  did);
