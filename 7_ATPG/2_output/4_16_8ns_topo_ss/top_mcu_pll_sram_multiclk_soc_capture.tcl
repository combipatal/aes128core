...
# arguments: /DATA/home/edu135/aes128_core/7_ATPG/2_output/4_16_8ns_topo_ss/top_mcu_pll_sram_multiclk_soc_capture.tcl -mode capture -wft _default_WFT_ -replace
...
create_clock -name rst_n_wft1 -period 100 -waveform { 55 145 } [get_ports rst_n]
...
set_false_path -hold -from  [get_clocks ref_clk_wft1 ] -to [get_clocks rst_n_wft1 ]
set_multicycle_path -setup 2 -rise_from  [get_clocks ref_clk_wft1 ] -rise_to [get_clocks rst_n_wft1 ]
set_false_path -hold -from  [get_clocks rst_n_wft1 ] -to [get_clocks ref_clk_wft1 ]
set_multicycle_path -setup 2 -fall_from  [get_clocks rst_n_wft1 ] -fall_to [get_clocks ref_clk_wft1 ]
...
set_input_delay 0 -clock forcePI_wft1  [get_ports scan_en]
